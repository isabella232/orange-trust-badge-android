...
/**
 * List of possible status app usage.
 */
enum class AppUsesPermission {
    /**
     * Host app use this permission
     */
    TRUE,
    /**
     * Host app does not use this permission
     */
    FALSE,
    /**
     * NOT to be take in account
     */
    NOT_SIGNIFICANT
}
